        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            ...
            <nav className="flex items-center gap-4">
              <a href="https://nhvpickleball.com" target="_blank" rel="noopener noreferrer" className="text-sm text-gray-600 hover:text-primary-600 transition">
                Website
              </a>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
              Join us for an exciting 8-week competitive season. Build your skills, make new friends, and compete in a supportive community.
            </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
            ...
            <div className="card p-6">
              ...
              <p className="text-gray-600">
                Play at your level with Beginner, Intermediate, and Advanced divisions to ensure competitive balance.
              </p>
            </div>
            ...
            <div className="card p-6">
              ...
              <p className="text-gray-600">
                Consistent Tuesday through Thursday evening matches throughout May and June. Perfect for building momentum and friendships.
              </p>
            </div>
            ...
            <div className="card p-6">
              ...
              <p className="text-gray-600">
                Form teams with fellow players. Interested captains get leadership opportunities and special recognition.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 sm:py-20 bg-primary-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-gray-600 text-lg mb-8">
            Registration is open now. Don't miss your chance to be part of New Haven's fastest-growing pickleball community.
          </p>
          {hasActiveEvent && (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 mb-8">
            ...
            <div>
              ...
              <div className="flex flex-col gap-2 text-sm">
                <a href="https://nhvpickleball.com" target="_blank" rel="noopener noreferrer" className="text-primary-400 hover:text-primary-300">
                  Website: nhvpickleball.com
                </a>
                <a href="https://instagram.com/nhvpbleague" target="_blank" rel="noopener noreferrer" className="text-primary-400 hover:text-primary-300">
                  Instagram: @nhvpbleague
                </a>
                <a href="https://facebook.com/groups/EastRockPickleball" target="_blank" rel="noopener noreferrer" className="text-primary-400 hover:text-primary-300">
